                  ...
                  <div class="box">
                    ...
                    <div class="panel-body" style="height: 400px;" id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST">
                          ...
                          <!-- div class="form-group col-lg-4 col-md-6 col-sm-4 col-xs-12">
                            <label id ="lbl_obra" name="lbl_obra" >Obra (sólo si corresponde):</label>
                            <input type="hidden" name="idestadopago" id="idestadopago">
                            <select id="venta_idObra" name="venta_idObra" class="form-control selectpicker" data-live-search="true" >
                            </select>
                          </div -->
                          ...
                          <div class="form-group col-lg-2 col-md-2 col-sm-6 col-xs-12">
                            <label>Número (*):</label>
                            <input type="number" class="form-control" name="num_comprobante" id="num_comprobante" maxlength="10" placeholder="Número" required="true">
                          </div>
                          <div class="form-group col-lg-2 col-md-2 col-sm-6 col-xs-12">
                           ...
                           <div class="form-group col-lg-12 col-md-12 col-sm-8 col-xs-12">
                            ...
                            <textarea class="form-control" rows="3" placeholder="Aquí puedes incluir condiciones de pago, plazos de entrega,  N°OC y otras generalidades" name="obs_venta" id="obs_venta" maxlength="500"></textarea>
                          </div>

                          <div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <a data-toggle="modal" href="#myModal">           
                              <button id="btnAgregarArt" type="button" class="btn btn-primary"> <span class="fa fa-plus"></span> Agregar Items</button>
                            </a>
                          </div>
