            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h1 class="box-title">Productos <button class="btn btn-success" id="btnagregar"
                                onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> Agregar </button> <a
                                target="_blank" href="../reportes/rptproductos.php"><button class="btn btn-info">Reporte
                                </button></a></h1>
                    ...
                    <div class="panel-body" id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST">
                            <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                ...
                                <input type="text" class="form-control" name="nombre" id="nombre" maxlength="150"
                            ...
                            <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                <label>Stock(*):</label>
                                <input type="number" step="0.01" class="form-control" name="stock" id="stock" required>
                            </div>
                            <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                <label>Valor Neto(*):</label>
                                <input type="number" class="form-control" name="valor_neto" id="valor_neto" required>
                            </div>
                            <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                <label>Unidad de medida(*):</label>
                                <select id="idmedida" name="idmedida" class="form-control selectpicker"
                                    data-live-search="true" required>
                                    <option value="m2">Metro cuadrado (m2)</option>
                                    <option value="m">Metro lineal (m)</option>
                                    <option value="m3">Metro cúbico(m3)</option>
                                    <option value="Trato">Por trato (T)</option>
                                    <option value="h">Hora (h)</option>
                                    <option value="Km">Kilómetro(km)</option>
                                    <option value="GL">Global(GL)</option>
                                    <option value="ND">No definida(ND)</option>
                                </select>
                            </div>
                            <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
