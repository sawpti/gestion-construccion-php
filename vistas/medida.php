            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h1 class="box-title">Medidas <button class="btn btn-success" id="btnagregar"
                                onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> Agregar</button></h1>
                        <div class="box-tools pull-right">

                        </div>
                        <div class="panel-body" style="padding: 10px;">
                            <label>Selecciona una obra para ver sus medidas o agregar una nueva medida</label>
                        </div>
                    ...
                    <div class="panel-body" style="height: 400px;" id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST">
                            ...
                            <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                ...
                                <select id="idcontacto" name="idcontacto" class="form-control selectpicker"
                                    data-live-search="true" required>
                                </select>
                            </div>
                            ...
                            <div class="form-group col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <label>Comuna:</label>
                                <select id="idcomuna" name="idcomuna" class="form-control selectpicker"
                            ...
                            <div class="form-group col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                ...
                                <input type="text" class="form-control" style="text-transform:uppercase;"
                                    onkeyup="javascript:this.value=this.value.toUpperCase();" name="lugar" id="lugar"
                                    maxlength="100" placeholder="Lugar o sector">

                            </div>
                            <div class="form-group col-lg-5 col-md-4 col-sm-6 col-xs-12">
                                <label>Dirección:</label>
                                <input type="text" class="form-control" style="text-transform:uppercase;"
                                    onkeyup="javascript:this.value=this.value.toUpperCase();" name="direccion"
                                    id="direccion" maxlength="150" placeholder="Dirección" required>
                            </div>

                            <div class="form-group col-lg-6 col-md-4 col-sm-6 col-xs-12">
                                <label>Título</label>
                                <input type="text" class="form-control" style="text-transform:uppercase;"
                                    onkeyup="javascript:this.value=this.value.toUpperCase();" name="titulo" id="titulo"
                                    maxlength="100" placeholder="Título de la cotización" require>

                            </div>

                            <div class="form-group col-lg-4 col-md-3 col-sm-6 col-xs-12">
                                <label>Tipo Impuesto(*):</label>
                                <select name="tipo_impuesto" id="tipo_impuesto" class="form-control selectpicker"
                                    required="">
                            ...
                            <div class="form-group col-lg-6 col-md-6 col-sm-8 col-xs-12">
                                ...
                                <textarea class="form-control" rows="3"
                                    placeholder="Aquí puedes incluir generalidades de las Especificaciones Técnicas. Para abordar aspectos más puntuales la recomendación es crear un anexo en Word u otro editor de texto."
                                    name="etecnicas" id="etecnicas" maxlength="550"></textarea>
                            </div>
                            <div class="form-group col-lg-6 col-md-6 col-sm-8 col-xs-12">
                                <label>Observaciones: </label>
                                <textarea class="form-control" rows="3"
                                    placeholder="Aquí puedes incluir condiciones de pago, plazos de entrega y otras generalidades"
                                    name="observaciones" id="observaciones" maxlength="249"></textarea>
                            </div>
                            <div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                <a data-toggle="modal" href="#myModal">
                                    <button id="btnAgregarArt" type="button" class="btn btn-primary"> <span
                                            class="fa fa-plus"></span> Agregar Detalle</button>
                                </a>
                            </div>
                            ...
                            <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12 table-responsive">
                                <table id="detalles"
                                    ...
                                    <tfoot>
                                        ...
                                        <th></th>
                                        <th>
                                            <h4 id="total">$ 0.00</h4><input type="hidden" name="total_cotizacion"
                                                id="total_cotizacion">
                                        </th>
                                    </tfoot>
                                    <tbody>
