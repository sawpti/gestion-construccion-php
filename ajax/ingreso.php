...
switch ($_GET["op"]){
    case 'guardaryeditar':
        if (empty($idingreso)){
            $rspta=$ingreso->insertar($idproveedor,$idusuario,$tipo_comprobante,$serie_comprobante,$num_comprobante,$fecha_hora,$impuesto,$total_compra,$idempresa_u,$_POST["idarticulo"],$_POST["cantidad"],$_POST["precio_compra"],$_POST["precio_venta"]);
    ...
    case 'listar':
        $rspta=$ingreso->listar($idempresa_u);
    ...
    case 'listarArticulos':
        ...
        $rspta=$articulo->listarProductosActivos($idempresa_u);
        //Vamos a declarar un array
        $data= Array();
