...
$nombre_fantasia= $_SESSION['nombre_fantasia'];
...
<table border="0" align="center" width="300px">
    ...
    <tr>
      <td colspan="3">Cantidad: <?php echo number_format($cantidad,2,',','.'); ?></td>
    </tr>
    <tr>
      <td colspan="3">&nbsp;</td>
    </tr>      
    ...
    <tr>
      <td colspan="3" align="center"> <?php echo $nombre_fantasia ?></td>
    </tr>
    <tr>
      <td colspan="3" align="center"><?php echo $ciudad ?> - Chile</td>
    </tr>
